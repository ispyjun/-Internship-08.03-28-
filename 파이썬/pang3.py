...
def Gameplay5():
    ...
    while running:
        ...
        for ball2_idx,ball2_val in enumerate(balls2):
            ...
            if  ball2_pos_y<=180 or ball2_pos_y+ball2_height>=150 and ball2_pos_x + ball2_width>=160 and ball2_pos_x<=480:
                ball2_val["to_y"]=ball2_val["init_spd_y"]*-1
            
            if  ball2_pos_x<=480 or ball2_pos_x + ball2_width>=160 and ball2_pos_y+ball2_height>=150 and ball2_pos_y<=180:
                ball2_val["to_x"]=ball2_val["to_x"]*-1
